...
letras.splice(2,1) // con el indice 2, voy a la ubicacion de la 'c' y borro la letra, con el segundo parametro, elijo cuanto borrar del array 
console.log(letras);

letras.splice(2,0,'x', 'y')  // con el indice 2, voy la ubicacion en la que me piden agregar 'x' y 'y', con el tercer parametro paso lo que quiero agragar al array
console.log(letras);
